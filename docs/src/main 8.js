...
function formatChineseText(value) {
  return wrapLatinRuns(escapeHtml(value))
}

function formatChineseHtml(value) {
  return wrapLatinRuns(value)
}
...
function bilingualText(value) {
  ...
  return `<span class="body-copy-en">${english}</span><span class="body-copy-zh" lang="zh-Hant">${formatChineseText(translation)}</span>`
}

function bilingualRich(englishHtml, traditionalHtml) {
  return `<span class="body-copy-en">${englishHtml}</span><span class="body-copy-zh" lang="zh-Hant">${formatChineseHtml(traditionalHtml)}</span>`
}
