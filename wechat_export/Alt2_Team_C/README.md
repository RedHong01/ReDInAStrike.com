...
- `transcript_partial.md` contains the screen-verified transcript from the group creation boundary (2026-01-28) through the latest locally indexed history; media/deleted uncertainty remains explicitly labeled.
